...
$sql = "SELECT cl.nombre, cl.paterno, cl.materno, cl.correo, cl.telefono, cl.genero, cl.pais, us.usuario
    FROM cliente as cl
...
while($row = $datos->fetch_assoc()){
    ...
    $pdf->Cell(30, 10, $row['pais'], 1, 0, 'C', 0);
